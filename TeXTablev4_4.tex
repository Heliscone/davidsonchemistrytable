...
%%TITLE%%-------------------------------------------------------------------------------
	...
	\node at ($0.5*(H.west) + 0.5*(He.east)+(0,7)$) (Titles) [scale=2, font={\sffamily\Huge\bfseries}] {Periodic Table of Elements v4.4};
