...
\usepackage{amssymb}
\usepackage{amsfonts}
%Adapted by Evan Lim. Many thanks to Ivan Griffin for the original work, and to Janosh Riebessel, whose remix I have modified.
\begin{document}
...
%%FORMULAS%%
	...
	%Constants
;	\node at ($(Be.north)+(1,5.3)$) (Constants) [draw] [text width = 9.4cm, align=left] {$R_{\text{gas-law}}=0.0821\dfrac{\text{L}\cdot\text{atm}}{\text{mol}\cdot\text{K}}=62.4\dfrac{\text{L}\cdot\text{mmHg}}{\text{mol}\cdot{K}}=8.314\dfrac{\text{L}\cdot\text{kPa}\lor\text{J}}{\text{mol}\cdot\text{K}}$\\ \vspace{0.3cm}
$\dfrac{453.6\text{ g}}{1\text{ lb}}=\dfrac{2.54\text{ cm}}{1\text{ in}}=\dfrac{0.946\text{ L}}{1\text{ qt}}=\dfrac{6.022\times10^{23}\text{ units}}{\text{mol}}=\dfrac{22.4\text{ L}}{\text{mol}}$\\ \vspace{0.3cm}$\dfrac{1\text{ g}_{\text{water}}}{1\text{ mL}_{\text{water}}}=\dfrac{P_{\text{sea}}}{101325\text{ Pa}}=\dfrac{1\text{ atm}}{760\text{ mmHg}}=\dfrac{1\text{ atm}}{14.7\text{ psi}}$\\ \vspace{0.3cm} $^{\circ}\text{C}=\frac{5}{9}(^{\circ}\text{F}-32)$ and $^{\circ}\text{F}=\frac95 ^{\circ}\text{C}+32$\\ \vspace{0.3cm} $h=6.626\times10^{-34}\text{Js}\lor\text{kgm}^2\text{s}^{-1}$ and $c=3.00\times10^8\text{ ms}^{-1}$};
	...
	%Thermodynamics
	\node at ($(Be.north)+(2,1.7)$) (Thermo) [draw] [text width = 6cm, align = left] {$\triangle H_{\text{vap}}=40.67\text{kJ mol}^{-1}$\\$\triangle H_{\text{fus}}=6.01\text{kJ mol}^{-1}$\\  $C_{\text{ice}}=2.11\text{J (gK)}^{-1}$\\ $C_{\text{water}}=4.184\text{J (gK)}^{-1}$\\ $C_{\text{steam}}=1.865\text{J (gK)}^{-1}$};
	...
	%Kinematics
	\node at ($(Gasses.east)+(1.4,-0.2)$) (Kinematics) [draw] [text width = 2.5cm, align = left] {$k=Ae^{-\frac{E_a}{RT}}$\\$[A]_t=[A]_0-kt$\\ $[A]_t=[A]_0e^{-kt}$\\$[A]_t=\frac{1}{kt+\frac{1}{[A]_0}}$};
	%entropy
	\node at ($(Mn.north)+(0,2)$) (Entropy) [draw] [text width = 8cm, align = left] {$\triangle E = q+w=q-P\triangle V$ and $\triangle H=\triangle E+P\triangle V$\\ Isotherm, $\triangle S = \frac{q_{\text{if-reverse}}}{T}$, or $S=k\ln W$ (micro-state)\\ \vspace{1mm} $k=1.38\times10^{-23}\text{ JK}^{-1}$\\ \vspace{1mm} $\triangle S = k\ln\left(\frac{W_{\text{final}}}{W_{\text{initial}}}\right)$ and $\triangle S_{\text{surr.}}=-\frac{\triangle H^{\circ}}{T}$\\ \vspace{1mm} $-T\triangle S_{\text{universe}}=\triangle H_{\text{system}}-T\triangle S_{\text{system}}$\\ \vspace{1mm} $\triangle G:= -T\triangle S_{\text{universe}}=\triangle H^{\circ}-T\triangle S^{\circ}$};
\end{tikzpicture}
