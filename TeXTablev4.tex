...
\begin{tikzpicture}[font=\sffamily]
  ...
  % Group 4 - IVB
	...
	\node[below of=Hf, Metal] (Rf) {\SyntheticElem{104}{(267)}{Rf}{\hspace{-1pt}Rutherfordium}};
  ...
  \node[right of=Ce, LanthanideActinide] (Pr) {\NaturalElem{59}{140.91}{Pr}{1.13}{\hspace{-1pt}Praseodymium}};
...
%%TITLE%%-------------------------------------------------------------------------------
	...
	\node at ($0.5*(H.west) + 0.5*(He.east)+(0,7)$) (Titles) [scale=2, font={\sffamily\Huge\bfseries}] {Periodic Table of Elements v4.2};
...
%%FORMULAS%%----------------------------------------------------------------------------
	...
	\node (Walent)
	[align = center, text width = 160pt, text height = 4pt, anchor = north west, label={[font=\sffamily\bfseries,anchor=north]north: Walent (Wa)}] at ($(Quantum.north east)+(2,0)$) {
