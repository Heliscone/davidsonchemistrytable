...
%%TITLE%%-------------------------------------------------------------------------------
	...
	\node at ($0.5*(H.west) + 0.5*(He.east)+(0,7)$) (Titles) [scale=2, font={\sffamily\Huge\bfseries}] {Periodic Table of Elements v4};
...
%%FORMULAS%%----------------------------------------------------------------------------
	...
	[align = center, text width = 140pt, text height = 8pt, anchor = south east, label={[font=\sffamily\bfseries,anchor=north]north: Periodic Trends}] at ($(Units.north east)+(0,0.5)$) {
		\\[2ex]
		EN, IE, EA, \& $\mathbb{Z}_{eff}$ increase $\rightarrow\uparrow$\\
