...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[below of=Cr, Metal] (Mo) {\NaturalElem{42}{95.94}{Mo$^{\bigstar}$}{2.16}{Molybdenum}};
  ...
  \node[below of=Ni, Metal] (Pd) {\NaturalElem{46}{106.42}{Pd$^{\bigstar}$}{2.20}{Palladium}};
  ...
  % Group 12 - IIB
  \node[right of=Cu, Metal] (Zn) {\NaturalElem{30}{65.39}{Zn}{1.65}{Zinc\textsuperscript{(2+)}}};
  ...
  \node[below of=Si, Metalloid] (Ge) {\NaturalElem{32}{72.64}{Ge}{2.01}{Germanium}};
  ...
  % Group 16 - VIA
  \node[right of=N, Nonmetal] (O) {\NaturalElem{8}{116.00}{O\textsubscript{2}}{3.44}{Oxygen}};
  \node[below of=O, Nonmetal] (S) {\NaturalElem{16}{32.10}{S}{2.38}{Sulphur}};
  \node[below of=S, Nonmetal] (Se) {\NaturalElem{34}{78.96}{Se}{2.55}{Selenium}};
  ...
  \node[below of=At, Element] (Uus) {\SyntheticElem{117}{(294)}{Ts}{Tennessine}};
  ...
  \node[below of=Rn, Nonmetal] (Uuo) {\SyntheticElem{118}{(294)}{Og}{Ogannesson}};
