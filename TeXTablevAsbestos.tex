...
\newcommand{\LongElem}[5]{\ElemLabels{#1}{#2}{\LARGE {#3}}{{#4}}{\small{#5}}}
\newcommand{\LongLongElem}[5]{\ElemLabels{#1}{#2}{\LARGE {#3}}{{#4}}{\footnotesize{#5}}}
\newcommand{\LongSyntheticElem}[4]{\ElemLabelNEN{#1}{#2}{\LARGE {#3}}{\small {#4}}}
\newcommand{\LongLongSyntheticElem}[4]{\ElemLabelNEN{#1}{#2}{\LARGE {#3}}{\footnotesize {#4}}}
...
\newcommand{\LongSyntheticElemEN}[5]{\ElemLabels{#1}{#2}{\color{white}{\LARGE {#3}}}{#4}{\small{#5}}}
...
\begin{tikzpicture}[font=\sffamily]
  ...
  % Group 4 - IVB
	...
	\node[below of=Hf, Metal] (Rf) {\LongLongSyntheticElem{104}{(267)}{Rf}{Rutherfordium}};
  ...
  \node[below of=Cr, Metal] (Mo) {\LongElem{42}{95.95}{Mo$^{\bigstar}$}{2.16}{Molybdenum}};
  ...
  \node[below of=Pt, Metal] (Ds) {\SyntheticElem{110}{(281)}{Ds}{\hspace{-1pt}Darmstadtium}};
  ...
  \node[below of=Au, Metal] (Rg) {\LongSyntheticElem{111}{(282)}{Rg}{Roentgenium}};
  ...
  \node[below of=Hg, Metal] (Uub) {\LongSyntheticElem{112}{(285)}{Cn}{Copernicium}};
  ...
  \node[below of=Po, Metal] (Uuh) {\LongSyntheticElem{116}{(293)}{Lv}{Livermorium}};
  ...
  \node[right of=Ce, LanthanideActinide] (Pr) {\LongLongElem{59}{140.91}{Pr}{1.13}{Praseodymium}};
  ...
  \node[right of=Th, LanthanideActinide] (Pa) {\LongElem{91}{231.04}{Pa}{1.5}{Protactinium}};
  ...
  \node[right of=Fm, LanthanideActinide] (Md) {\LongSyntheticElemEN{101}{(258)}{Md}{1.3}{Mendelevium}};
...
%%TITLE%%-------------------------------------------------------------------------------
	...
	\node at ($0.5*(H.west) + 0.5*(He.east)+(0,7)$) (Titles) [scale=2, font={\sffamily\Huge\bfseries}] {Periodic Table of Elements vAsbestos};
...
%%FORMULAS%%----------------------------------------------------------------------------
	...
	%	\begin{tabular}{rl rl}
	%	&\\
	%	$\text{mmHg}$&mm of Mercury	&$\text{(k)J}$&(kilo)Joule(s)\\ 
	...
	\node (Trend)
	[align = center, text width = 140pt, text height = 8pt, anchor = south east, label={[font=\sffamily\bfseries,anchor=north]north: Periodic Trends}] at ($(Constants.north east)+(0,0.5)$) {
		\vspace{-2pt}\\
	...
	$^{\circ}\text{C}=\frac59(^{\circ}\text{F}-32)$\\
	$^{\circ}\text{F}=\frac{9}{5}^{\circ}\text{C}+32$\\
	$1\text{ cal}=4.184\text{ J}$\\
	$1\text{ lb}=453.59\text{ g}$\\
	$1\text{ atm}=760\text{ mmHg}$\\
	$=760\text{ torr}=101.325\text{ kPa}$\\
	...
	[align=center, text width = 160pt, text height = 5pt, anchor = south west, label={[font=\sffamily\bfseries,anchor=north]north: Kinetics}] at ($(Gasses.south east)+(0.5,0)$) {
		\\[2ex]
		$[A]_t-[A]_0=-kt$ (0\textsuperscript{th} order)\\
		$\ln[A]_t-\ln[A]_0=-kt$ (1\textsuperscript{st} order)\\
		$\frac{1}{[A]_t}-\frac{1}{[A]_0}=kt$ (2\textsuperscript{nd} order)\\
		$t_{1/2}=\frac{0.693}{k}$ (1\textsuperscript{st} order)
	};
	\node (Bzzt)
	[align = center, text width = 160pt, text height = 5pt, anchor = south west, label={[font=\sffamily\bfseries,anchor=north]north: Thermo/Electrochem}] at ($(Kinetics.north west)+(0,0.5)$) {
		\\[1ex]
		$q\hspace{-2.5pt}=\hspace{-2.5pt}mc\Delta T$, $\Delta E\hspace{-2.5pt} =\hspace{-2.5pt} q+w$, $H=E+PV$\\
		$\Delta S^{\circ}=\sum_{\text{products}} S^{\circ}-\sum_{\text{reactants}} S^{\circ}$\\
		$\uparrow$ Likewise for $\Delta H^{\circ}$ and $\Delta G^{\circ}$ $\uparrow$\\
	...
	[align = center, text width = 160pt, text height = 4pt, anchor = south west, label={[font=\sffamily\bfseries,anchor=north]north: Quantum}] at ($(Bzzt.north west)+(0,0.5)$) {
		\\[2ex]
		$E_{\text{photon}}=hf=\frac{hc}{\lambda}\implies c=\lambda f$\\
		$\lambda=\frac{h}{mv}$\\
	...
	\node (Solutions)
	[align = center, text width = 160pt, text height = 4pt, anchor = north west, label={[font=\sffamily\bfseries,anchor=north]north: Solutions (cont.)}] at ($(Quantum.north east)+(0.5,0)$) {
			\begin{align*}
				\Delta T_b=K_bmi\phantom{00}&\phantom{00}\Delta T_f=-K_fmi\\
				P_A=X_AP^{\circ}_A\phantom{00}&\phantom{00}S_g=kP_g\\
				\Pi=\left(\frac{n}{V}\right)RT&=MRT\\
				(K_{b_{\text{water}}},K_{f_{\text{water}}})&=(0.512,1.86)^{\circ}\text{C/m}\\
				\Delta H_{\text{fus}_{\text{water}}}&=6.008\text{ kJ/mol}\\
				\Delta H_{\text{vap}_{\text{water}_{100^{\circ}\text{C}}}}&=40.67\text{ kJ/mol}\\
				c_{\text{ice}}&=2.093\text{ J}/(\text{g}^{\circ}\text{C})\\
				c_{\text{water}}&=4.184\text{ J}/(\text{g}^{\circ}\text{C})\\
				c_{\text{steam}}&=1.841\text{ J}/(\text{g}^{\circ}\text{C})
			\end{align*}
	};
	\node (Walent)
	[align = center, text width = 160pt, text height = 4pt, anchor = north west, label={[font=\sffamily\bfseries,anchor=north]north: Walent (Wa)}] at ($(Solutions.north east)+(0.5,0)$) {
			\[1\text{ Walent}=0.082\text{ L(mol K)}^{-1}\]
			\begin{align*}
				R&=1\text{ Walentmosphere (Wam)}\\
				&=1 \textit{ Walentorr}
			\end{align*}
			$1\text{ m}^3=8.2\times10^{-5}\text{ Wamokel (Wal)}$
